...
def validate_args(args) -> None:
    ...
    if uses_late_stage_guidance and guidance_timesteps and args.candidate_inference_steps is not None and max(int(v) for v in guidance_timesteps) > int(args.candidate_inference_steps):
        raise ValueError(
